...
class HomepageView
{
    ...
    <head>
        ...
        <main class="container">
            <section class="hero">
                <h1 class="title">
                    <span style="color: var(--blacktext-color)">Dash</span><span style="color: var(--text-primary)">Med</span>
                </h1>
            ...
            <section>
                <p>
                    ...
                    l’information circule de façon claire et sécurisée. L’idée est simple : permettre aux soignants
                    de se concentrer sur leurs patients plutôt que sur la gestion administrative, et offrir aux
        ...
        <footer>
            <svg width="100%" viewBox="0 0 1920 241" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                241 1680 241C1760 241 1840 241 1880 241H1920V208.188Z" fill="#275AFE"/>
            </svg>
            <section>
