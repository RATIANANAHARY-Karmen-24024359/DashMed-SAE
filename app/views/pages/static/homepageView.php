    ...
    public function show(): void
    {
        ...
        <head>
            ...
            <meta name="description"
                content="DashMed est une plateforme qui simplifie le suivi médical entre médecins et patients.">
        ...
        <body>
            ...
            <main class="container">
                <section class="hero">
                    <h1 class="title">
                        <span style="color: var(--blacktext-color)">Dash</span><span
                            style="color: var(--primary-color)">Med</span>
                    </h1>
