                        ...
                        <?php if (!empty($this->consultations)) : ?>
                            <?php foreach ($this->consultations as $consultation) :
                                ...
                                <article class="consultation"
                                         id="consultation-<?php echo $consultation->getId(); ?>"
                                         data-date="<?php
                                            ...
                                            <div class="action-buttons">
                                                ...
                                                <button class="btn-icon delete-btn"
                                                    ...
                                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0
                                                        0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                                                    </svg>
                                                </button>
                                            </div>
                                            <?php endif; ?>
                ...
                <form id="add-consultation-form" method="POST" action="?page=medicalprocedure">
                    ...
                    <div class="form-group">
                            ...
                            <select id="doctor-select" name="doctor_id" required>
                                ...
                                <?php foreach ($this->doctors as $doc) : ?>
                                    <option value="<?php echo htmlspecialchars((string) $doc['id_user']); ?>" 
                                        ...
                                        $doctorName = htmlspecialchars($doctorName, ENT_QUOTES, 'UTF-8');
                                        ?>
                                        Dr. <?= $doctorName ?>
                        ...
                        <?php else : ?>
                            ...
                            ?>
                            <input type="text" value="<?php echo htmlspecialchars($docName); ?>"
